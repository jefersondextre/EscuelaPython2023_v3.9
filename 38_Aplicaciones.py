...
Análisis: Para la solución de este problema, se requiere que el usuario ingrese un número y 
el sistema realice el proceso para devolver la suma de los N primeros números.



Aplicación 04: Iterar una lista
Enunciado: obtén todos lo elementos de una lista usando fot loop y whike loop

Análisis: para solucionar este problema se requiere una lista con elementos e 
iterar cada uno des sud elementos como una lista.
...
se llamará pares y el segundo impar, ambos estarán vacíos. Después multiplica 
cada uno de los números de la tupla por un número aleatorio entre 1 y 100,
si el resultado es par guarda ese número en la lista de pares y si es impar 
en la lista  de impares. Muestra por consola: -la multiplicación que se 
produce junto con su resultado con el formato 2 x 3 = 6 y la lista de pares 
e impares
